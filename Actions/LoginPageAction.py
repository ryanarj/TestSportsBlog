...
class LoginPageAction:
    ...
    def run(self, username=None, password=None, submit_btn=None, clean_fields=None):
        ...
        if clean_fields is not None:
            self.driver.find_element_by_css_selector(LoginPage().username_text()).clear()
            self.driver.find_element_by_css_selector(LoginPage().password_text()).clear()
